...
#endif
extern size_t strlcpy(char *__restrict dest, const char *__restrict src, size_t destsize);

extern size_t strlcat(char *__restrict dest, const char *__restrict src, size_t destsize);
